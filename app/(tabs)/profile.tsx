    ...
    <SafeAreaView style={[styles.container, {marginTop: StatusBar.currentHeight},tw``]} darkColor="black">
      ...
      <ScrollView style={[tw`w-full px-2`]}>
        <View style={tw`w-full flex flex-row items-center justify-center mt-32`}>
          <Image
            style={[{aspectRatio:1,resizeMode:'contain'},tw`rounded-3xl opacity-75 h-80 w-4/5`]}
            source={require('../../assets/images/people/lady.png')}
          />
        </View>
        <View style={tw`w-full px-4 flex items-center `}>
        <TouchableOpacity style={[{...defaultStyle.IosBoxShadow,...defaultStyle.androidBoxShadow},tw`w-full bg-white my-2 py-2 rounded-3xl`]} onPress={()=>{}}>
                        <View style={[tw`w-full flex flex-row justify-between bg-transparent rounded-xl px-2.5 py-2`]}>
                            ...
                            <View style={tw`flex flex-row bg-transparent`}>
                                ...
                                <View style={tw`bg-transparent`}>
                                    <Text numberOfLines={1} style={tw`font-bold text-lg`} darkColor='black'>{'Change Avatar'}</Text>
                                </View> 
                        ...
                        <View style={[tw`w-full flex flex-row justify-between bg-transparent rounded-xl px-2.5 py-2`]}>
                            ...
                            <View style={tw`flex flex-row bg-transparent`}>
                                ...
                                <View style={tw`bg-transparent ml-4`}>
                                    <Text numberOfLines={1} style={tw`font-bold text-lg`} darkColor='black'>{'Verification'}</Text>
                                </View> 
        ...
        <TouchableOpacity style={[{...defaultStyle.IosBoxShadow,...defaultStyle.androidBoxShadow},tw`w-full bg-white my-2 py-2 rounded-3xl`]} onPress={()=>{}}>
                        <View style={[tw`w-full flex flex-row justify-between bg-transparent rounded-xl px-2.5 py-2`]}>
                            ...
                            <View style={tw`flex flex-row bg-transparent`}>
                                ...
                                <View style={tw`bg-transparent ml-4`}>
                                    <Text numberOfLines={1} style={tw`font-bold text-lg`} darkColor='black'>{'Details'}</Text>
                                </View> 
